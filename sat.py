"""
Implements the Seperating Axis Theorem in python

CREDITS: https://github.com/JuantAldea/Separating-Axis-Theorem/blob/master/python/separation_axis_theorem.py
"""
